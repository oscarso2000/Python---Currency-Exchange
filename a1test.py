...
def testB():
    ...
    introcs.assert_equals('1.727138 Euros', a1.get_rhs('{ "ok": true, "lhs" : "2 United States Dollars", "rhs" : "1.727138 Euros",  "err" : "" }'))
    ...
    introcs.assert_equals(True, a1.has_error( '{ "ok": true, "lhs" : "", "rhs" : "", "err" : "Source currency code is invalid." }'))
    ...
    introcs.assert_equals(False, a1.has_error('{"ok": true, "lhs" : "2 United States Dollars", "rhs" : "1.727138 Euros", "err" : "" }'))
    ...
    introcs.assert_equals(True, a1.has_error('{ "ok":false, "lhs":"", "rhs":"", "err":"Exchange currency code is invalid." }'))
...
def testC():
    ...
    introcs.assert_equals('{ "ok":true, "lhs":"2.5 United States Dollars", "rhs":"64.375 Cuban Pesos", "err":"" }',
    ...
    introcs.assert_equals('{ "ok":true, "lhs":"2.5 United States Dollars", "rhs":"2.2160175 Euros", "err":"" }',
    ...
    introcs.assert_equals('{ "ok":true, "lhs":"100 United States Dollars", "rhs":"782.455 Hong Kong Dollars", "err":"" }',
            a1.currency_response("USD","HKD",100))

    #invalid source
    introcs.assert_equals('{ "ok":false, "lhs":"", "rhs":"", "err":"Source currency code is invalid." }',
            a1.currency_response("asd","USD",2.5))

    #invalid amount
    introcs.assert_equals('{ "ok":false, "lhs":"", "rhs":"", "err":"Currency amount is invalid." }',
            a1.currency_response("USD","HKD",""))

    #invalid exchange empty
    introcs.assert_equals('{ "ok":false, "lhs":"", "rhs":"", "err":"Exchange currency code is invalid." }',
